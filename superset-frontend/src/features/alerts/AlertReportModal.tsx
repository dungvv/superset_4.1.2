...
const AlertReportModal: FunctionComponent<AlertReportModalProps> = ({
  ...
  const onSave = () => {
    ...
    const data: any = {
      ...
      extra: {
        ...(typeof currentAlert?.extra === 'string'
      ...
      >
        ...
        >
          ...
          >
            ...
            {formatOptionEnabled && reportFormat === 'CSV' && (
              <div style={{ marginTop: '8px' }}>
                <AntdCheckbox
                  checked={sendAsZip !== undefined ? sendAsZip : true}
                  onChange={(e: any) => setSendAsZip(e.target.checked)}
                >
                  {t('Send as ZIP')}
                </AntdCheckbox>
              </div>
